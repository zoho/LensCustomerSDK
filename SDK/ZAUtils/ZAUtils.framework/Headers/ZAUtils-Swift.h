...
#ifndef ZAUTILS_SWIFT_H
#define ZAUTILS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZAUtils",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface UIButton (SWIFT_EXTENSION(ZAUtils))
...
@interface UIView (SWIFT_EXTENSION(ZAUtils))
...
@interface UIViewController (SWIFT_EXTENSION(ZAUtils)) <UIPopoverPresentationControllerDelegate>
...
@interface UIViewController (SWIFT_EXTENSION(ZAUtils))
