...
#ifndef ASSISTTABLEDATASOURCE_SWIFT_H
#define ASSISTTABLEDATASOURCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AssistTableDataSource",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// This Abstract data source inherited table view delegate and datasource. This data source redirect and get the datas from its subclass.
SWIFT_CLASS("_TtC21AssistTableDataSource20ATAbstractDataSource")
...
@class NSIndexPath;
@interface ATAbstractDataSource (SWIFT_EXTENSION(AssistTableDataSource)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end

@interface ATAbstractDataSource (SWIFT_EXTENSION(AssistTableDataSource)) <UICollectionViewDelegate>
...
@class UIScrollView;
@interface ATAbstractDataSource (SWIFT_EXTENSION(AssistTableDataSource))
...
@interface ATAbstractDataSource (SWIFT_EXTENSION(AssistTableDataSource)) <UICollectionViewDataSource>
...
@class UIView;
@interface ATAbstractDataSource (SWIFT_EXTENSION(AssistTableDataSource)) <UITableViewDataSource, UITableViewDelegate>
