...
#ifndef LOTTIEHELPER_SWIFT_H
#define LOTTIEHELPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LottieHelper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIButton;
@class NSCoder;
SWIFT_CLASS("_TtC12LottieHelper17LottieMessageView")
