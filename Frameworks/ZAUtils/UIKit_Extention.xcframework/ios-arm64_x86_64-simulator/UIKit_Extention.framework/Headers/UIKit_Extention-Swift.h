...
#ifndef UIKIT_EXTENTION_SWIFT_H
#define UIKIT_EXTENTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIKit_Extention",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class UIColor;
@interface UIButton (SWIFT_EXTENSION(UIKit_Extention))
...
@interface UIView (SWIFT_EXTENSION(UIKit_Extention))
...
@interface UIViewController (SWIFT_EXTENSION(UIKit_Extention)) <UIPopoverPresentationControllerDelegate>
...
@interface UIViewController (SWIFT_EXTENSION(UIKit_Extention))
