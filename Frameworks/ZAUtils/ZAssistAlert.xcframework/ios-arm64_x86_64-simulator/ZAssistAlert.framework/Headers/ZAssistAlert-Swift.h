...
#ifndef ZASSISTALERT_SWIFT_H
#define ZASSISTALERT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZAssistAlert",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC12ZAssistAlert12ZAssistAlert")
