...
#ifndef DATEPICKERCONTROLLER_SWIFT_H
#define DATEPICKERCONTROLLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DatePickerController",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC20DatePickerController20DatePickerController")
...
@interface DatePickerController (SWIFT_EXTENSION(DatePickerController))
