...
#ifndef DRAWERCONTROLLER_SWIFT_H
#define DRAWERCONTROLLER_SWIFT_H
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC16DrawerController30DrawerChildTableViewController")
...
SWIFT_RESILIENT_CLASS("_TtC16DrawerController20DrawerViewController")
...
@interface DrawerViewController (SWIFT_EXTENSION(DrawerController)) <UIGestureRecognizerDelegate>
