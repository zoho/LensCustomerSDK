...
#ifndef PAGINGCONTROLLER_SWIFT_H
#define PAGINGCONTROLLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PagingController",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC16PagingController13ATBarViewCell")
...
SWIFT_CLASS("_TtC16PagingController20ATPageViewController")
...
@interface ATPageViewController (SWIFT_EXTENSION(PagingController)) <UIPageViewControllerDataSource>
...
@interface ATPageViewController (SWIFT_EXTENSION(PagingController)) <UIPageViewControllerDelegate>
