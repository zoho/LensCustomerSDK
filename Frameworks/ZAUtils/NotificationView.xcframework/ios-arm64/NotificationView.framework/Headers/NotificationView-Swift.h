...
#ifndef NOTIFICATIONVIEW_SWIFT_H
#define NOTIFICATIONVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotificationView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UILabel;
@class NSCoder;
SWIFT_CLASS("_TtC16NotificationView16NotificationView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
